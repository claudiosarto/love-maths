...
/**
 * The main game "loop", called withe the script is first loaded 
...
/**
 * Gets the operands (the numbers) and the operator (plus, minus, etc) d
...
/**
 * Gets the current incorrect score from DOM and increments it by 1
 */
